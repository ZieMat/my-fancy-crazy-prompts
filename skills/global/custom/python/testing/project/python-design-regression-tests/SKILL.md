---
name: python-design-regression-tests
description: Designs Python pytest tests that specifically prevent previously seen or likely regressions. Use this when you need to create tests that catch bugs from past incidents or prevent common regression patterns.
...
Design Python pytest tests that specifically prevent previously seen or likely regressions. This skill creates targeted tests that catch bugs from past incidents and prevent common regression patterns from recurring.
