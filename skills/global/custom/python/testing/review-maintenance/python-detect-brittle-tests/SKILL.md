---
name: python-detect-brittle-tests
description: Finds Python pytest tests that are fragile, overspecified, timing-sensitive, or coupled to internals. Use this when you need to identify tests that are likely to fail unnecessarily or require frequent maintenance.
...
Find Python pytest tests that are fragile, overspecified, timing-sensitive, or coupled to internals. This skill identifies tests that are likely to fail unnecessarily or require frequent maintenance, helping improve test suite reliability.
