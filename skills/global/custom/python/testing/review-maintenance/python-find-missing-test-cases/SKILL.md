---
name: python-find-missing-test-cases
description: Identifies important Python pytest test gaps in existing test suites. Use this when you need to find what's not being tested and prioritize adding tests for uncovered critical paths.
...
Identify important Python pytest test gaps in existing test suites. This skill analyzes code and existing tests to find what's not being tested and prioritizes adding tests for uncovered critical paths.
