---
name: python-stabilize-flaky-tests
description: Improves determinism, isolation, timing control, fixture hygiene, and environmental reliability in Python pytest tests in the pytest framework. Use this when you need to fix flaky tests that fail intermittently.
...
Improve determinism, isolation, timing control, fixture hygiene, and environmental reliability in Python pytest tests in the pytest framework. This skill fixes flaky tests that fail intermittently by addressing timing issues, state leakage, and environmental dependencies.
