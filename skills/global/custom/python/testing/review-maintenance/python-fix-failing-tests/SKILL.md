---
name: python-fix-failing-tests
description: Determines whether Python pytest test failures come from product bugs, outdated expectations, or test design issues. Use this when a test is failing and you need to diagnose the root cause.
...
Determine whether Python pytest test failures come from product bugs, outdated expectations, or test design issues. This skill diagnoses the root cause of test failures and recommends the appropriate fix.
