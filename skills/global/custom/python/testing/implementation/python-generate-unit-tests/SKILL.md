---
name: python-generate-unit-tests
description: Creates focused Python unit tests with clear assertions and minimal mocking. Use this when you need to generate unit tests for Python functions, methods, or classes using pytest.
...
Create focused Python unit tests with clear assertions and minimal mocking. This skill generates unit tests that verify behavior without coupling to implementation details, using the pytest framework.
